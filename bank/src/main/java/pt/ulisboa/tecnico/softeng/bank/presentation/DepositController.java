...
@Controller
@RequestMapping(value = "/banks/{bankCode}/clients/{clientID}/accounts/{iban}/deposit")
public class DepositController {
	...
	public String depositSubmit(Model model, @ModelAttribute BankOperationData operationData,
			@PathVariable String bankCode, @PathVariable String clientID, @PathVariable String iban ){
		
		logger.info("depositSubmit");
		...
		return "redirect:/banks/" + bankCode + "/clients/" + clientID + "/accounts/" + iban + "/deposit";
	}
}
